...
<body>
	...
	<ul class="breadcrumb">
		<li>${cate.cateName}</a></li>
		<li class="active">${goodsDetail.goodsName }</li>
	</ul>
			...
			<div id="tsShopContainer">
				<div id="tsImgS">
					<a href="${pageContext.request.contextPath}${goodsDetail.goodsPic}"
						...
						src="${pageContext.request.contextPath}${goodsDetail.goodsPic}"
		...
		<div class="col-md-8">
			...
			<div class="panel panel-default">
				<div class="panel-body bg_goodsdetail">
					<p>
						促销价：<span class="price_red "><small>￥</small>${goodsDetail.goodsDiscount}</span>
					</p>
					<p>
						原价：<span class="price"><small>￥</small>${goodsDetail.goodsPrice}</span>
					</p>
					<p>
			...
			<form id="fm_goods" class="form-inline" role="form" method="post">
				...
				<input type="hidden" name="goodsName"
					...
					type="hidden" name="goodsPic" value="${goodsDetail.goodsPic}" /> <input
					type="hidden" name="typeid"> <input type="hidden"
					name="contentid">
				...
				<div class="col-md-12">
					...
					<p>
						...
						<button class="btn btn-primary btn-sm" type="button"
							onclick="add('${pageContext.request.contextPath}')">加入购物车</button>
					</p>
				</div>
