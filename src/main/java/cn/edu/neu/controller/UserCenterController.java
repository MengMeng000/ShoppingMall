 ...
 */
@WebServlet(urlPatterns = { "/usercenter/updatePersonalPassword.action", "/usercenter/index.action",
		"/usercenter/getPersonalInfo.action", "/usercenter/updatePersonalInfo.action",
		"/usercenter/getPersonalPassword.action" })
