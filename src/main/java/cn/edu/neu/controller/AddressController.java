 ...
 */
@WebServlet(urlPatterns = { "/address/getMyAddress.action", "/address/delAddress.action",
		"/address/getAddressById.action", "/address/handleAddress.action", "/address/setDefaultAddress.action" })
