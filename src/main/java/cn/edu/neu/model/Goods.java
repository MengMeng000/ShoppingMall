...
public class Goods {
	...
	public Goods(int goodsId, int cateId, String goodsName, String goodsDisc, float goodsPrice, float goodsDiscount,
			...
			int goodsSales, String goodsPic, List<GoodsDetailType> typelist, List<Pic> pics) {
		super();
	...
	public String toString() {
		return "Goods [goodsId=" + goodsId + ", cateId=" + cateId + ", goodsName=" + goodsName + ", goodsDisc="
				...
				+ ", typelist=" + typelist + ", pics=" + pics + ", getGoodsId()=" + getGoodsId() + ", getCateId()="
				+ getCateId() + ", getGoodsName()=" + getGoodsName() + ", getGoodsDisc()=" + getGoodsDisc()
				+ ", getGoodsPrice()=" + getGoodsPrice() + ", getGoodsDiscount()=" + getGoodsDiscount()
				+ ", getGoodsSales()=" + getGoodsSales() + ", getGoodsStock()=" + getGoodsStock() + ", getGoodsPic()="
				+ getGoodsPic() + ", getGoodsOrigin()=" + getGoodsOrigin() + ", getGoodsMaterial()="
				+ getGoodsMaterial() + ", getGoodsPostalfee()=" + getGoodsPostalfee() + ", getGoodsDate()="
				+ getGoodsDate() + ", getTypelist()=" + getTypelist() + ", getPics()=" + getPics() + "]";
	}
